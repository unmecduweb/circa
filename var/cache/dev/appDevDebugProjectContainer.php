...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'lexik_translation.listener.clean_translation_cache' => 'getLexikTranslation_Listener_CleanTranslationCacheService',
            ...
            'mweb.admin.adminmenu' => 'getMweb_Admin_AdminmenuService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MwebAdminBundle', ($this->targetDirs[3].'/app/Resources/MwebAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MwebAdminBundle', ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MwebCoreBundle', ($this->targetDirs[3].'/app/Resources/MwebCoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MwebCoreBundle', ($this->targetDirs[3].'/src/Mweb/CoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LexikTranslationBundle', ($this->targetDirs[3].'/app/Resources/LexikTranslationBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LexikTranslationBundle', ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-+K6s939P3', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KRq3WbYif4', 0, 'xCcFn5-QycqAImVYNAxZ2+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cObhH-Rsq5', 0, 'xCcFn5-QycqAImVYNAxZ2+', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hzhvmYrFrr', 0, 'xCcFn5-QycqAImVYNAxZ2+', (__DIR__.'/pools'), $a));
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'mweb.admin.adminmenu', 1 => 'showMenu'), 0);
        ...
        $instance->addListenerService('kernel.request', array(0 => 'lexik_translation.listener.clean_translation_cache', 1 => 'onKernelRequest'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('parallax_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('content_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('artist_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('news_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('content_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('parallax_image', $f, $a, $b));
        $i->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater')));
        $i->addEventSubscriber($g);
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('parallax_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('news_image', $f, $a, $b));
        $i->addEventSubscriber($h);
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('content_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('news_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('content_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('news_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('parallax_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('artist_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('artist_image', $f, $a, $b));
        $i->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('artist_image', $f, $a, $b));
        $i->addEventSubscriber($this->get('stof_doctrine_extensions.listener.translatable'));
        $i->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'circa', 'user' => 'root', 'password' => 'fabfab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $e, $i, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000016db6a4e0000564c26747116d92a10d44120ed4a6a0e91acee8b0f15(
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Mweb/CoreBundle/Entity'), 1 => ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Entity'), 2 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/config/doctrine') => 'Lexik\\Bundle\\TranslationBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Mweb\\CoreBundle\\Entity');
        $d->addDriver($b, 'Mweb\\AdminBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('MwebCoreBundle' => 'Mweb\\CoreBundle\\Entity', 'MwebAdminBundle' => 'Mweb\\AdminBundle\\Entity', 'LexikTranslationBundle' => 'Lexik\\Bundle\\TranslationBundle\\Entity', 'GedmoTranslatable' => 'Gedmo\\Translatable\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0fc6806b46fed6128101d1ab10569c255a06697490434bc0d80931dac7980967');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Mweb\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('blop@niche.com' => 'FAB'), 'resetting' => array('blop@niche.com' => 'FAB'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Mweb\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Mweb\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Mweb\\AdminBundle\\Entity\\User');
    }
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_0000000016db6b3a0000564c26747116d92a10d44120ed4a6a0e91acee8b0f15(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
        ...
        return new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'Mweb\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['lexik_translation.exporter.json'] = new \Lexik\Bundle\TranslationBundle\Translation\Exporter\JsonExporter(false);
    }
    ...
    /**
     * Gets the 'lexik_translation.listener.clean_translation_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Lexik\Bundle\TranslationBundle\EventDispatcher\CleanTranslationCacheListener A Lexik\Bundle\TranslationBundle\EventDispatcher\CleanTranslationCacheListener instance
     */
    protected function getLexikTranslation_Listener_CleanTranslationCacheService()
    {
        return $this->services['lexik_translation.listener.clean_translation_cache'] = new \Lexik\Bundle\TranslationBundle\EventDispatcher\CleanTranslationCacheListener($this->get('lexik_translation.translation_storage'), $this->get('translator'), __DIR__, $this->get('lexik_translation.locale.manager'), NULL);
    }
    ...
    {
        return $this->services['lexik_translation.locale.manager'] = new \Lexik\Bundle\TranslationBundle\Manager\LocaleManager(array(0 => 'fr'));
    }
    ...
    protected function getLexikTranslation_TranslatorService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Mweb/CoreBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), array(0 => ($this->targetDirs[3].'/app/../web')));
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'partner' => array('quality' => 150, 'filters' => array('thumbnail' => array('size' => array(0 => 150), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'news' => array('quality' => 100, 'filters' => array('thumbnail' => array('size' => array(0 => 420), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'parallax' => array('quality' => 80, 'filters' => array('thumbnail' => array('size' => array(0 => 1920, 1 => 400), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array()), 'artist' => array('quality' => 80, 'filters' => array('thumbnail' => array('size' => array(0 => 800, 1 => 600), 'mode' => 'outbound')), 'jpeg_quality' => NULL, 'png_compression_level' => NULL, 'png_compression_filter' => NULL, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    /**
     * Gets the 'mweb.admin.adminmenu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mweb\AdminBundle\Listener\AdminMenu A Mweb\AdminBundle\Listener\AdminMenu instance
     */
    protected function getMweb_Admin_AdminmenuService()
    {
        return $this->services['mweb.admin.adminmenu'] = new \Mweb\AdminBundle\Listener\AdminMenu($this->get('security.token_storage'), $this->get('twig'), array('page' => array('beautyName' => 'Pages', 'menu' => 'page', 'class' => 'Mweb\\CoreBundle\\Entity\\Content', 'form' => 'Mweb\\CoreBundle\\Form\\ContentType', 'listProperties' => array('name' => array('dataName' => 'title', 'beautyName' => 'Nom', 'type' => 'string'), 'updated' => array('dataName' => 'updated', 'beautyName' => 'Mis à jour', 'type' => 'date'), 'created' => array('dataName' => 'created', 'beautyName' => 'Ajouté le', 'type' => 'date'), 'status' => array('dataName' => 'status', 'beautyName' => 'En ligne', 'type' => 'boolean')), 'views' => 'default', 'unique' => false), 'news' => array('beautyName' => 'Actualités', 'menu' => 'news', 'class' => 'Mweb\\CoreBundle\\Entity\\News', 'form' => '\\Mweb\\CoreBundle\\Form\\NewsType', 'views' => 'default', 'listProperties' => array('name' => array('dataName' => 'title', 'beautyName' => 'Nom', 'type' => 'string'), 'updated' => array('dataName' => 'updated', 'beautyName' => 'Mis à jour', 'type' => 'date'), 'created' => array('dataName' => 'created', 'beautyName' => 'Ajouté le', 'type' => 'date'), 'status' => array('dataName' => 'status', 'beautyName' => 'En ligne', 'type' => 'boolean')), 'unique' => false), 'artist' => array('beautyName' => 'Artistes', 'menu' => 'artist', 'class' => 'Mweb\\CoreBundle\\Entity\\Artist', 'form' => '\\Mweb\\CoreBundle\\Form\\ArtistType', 'views' => 'default', 'listProperties' => array('name' => array('dataName' => 'title', 'beautyName' => 'Nom', 'type' => 'string'), 'updated' => array('dataName' => 'updated', 'beautyName' => 'Mis à jour', 'type' => 'date'), 'created' => array('dataName' => 'created', 'beautyName' => 'Ajouté le', 'type' => 'date'), 'status' => array('dataName' => 'status', 'beautyName' => 'En ligne', 'type' => 'boolean')), 'unique' => false)), array('page' => array('beautyName' => 'Pages'), 'news' => array('beautyName' => 'Actualités'), 'artist' => array('beautyName' => 'Artistes')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c, $d), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $m, 'main', $o, $p, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58a9f1ddc47371.31597150', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $l, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $m, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json'), 'lexik_translation.loader.database' => array(0 => 'database')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ar.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.it.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.it.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.lt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 4 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.uk.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ru.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.hu.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pl.yml')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 4 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pt.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.af.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.de.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.de.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.sl.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/translations/messages.en.yml'), 4 => ($this->targetDirs[3].'/src/Mweb/CoreBundle/Resources/translations/messages.en.yml'), 5 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.en.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 8 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.en.yml')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 4 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.tr.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.es.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.es.yml')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/translations/messages.fr.yml'), 4 => ($this->targetDirs[3].'/src/Mweb/CoreBundle/Resources/translations/messages.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/lexik/translation-bundle/Resources/translations/LexikTranslationBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 8 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fr.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml')), 'ky' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ky.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ky.yml')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Mweb\AdminBundle\Twig\TwigExtension($this));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'MwebAdminBundle', 8 => 'MwebCoreBundle', 9 => 'LexikTranslationBundle', 10 => 'AsseticBundle', 11 => 'FOSUserBundle', 12 => 'StofDoctrineExtensionsBundle', 13 => 'VichUploaderBundle', 14 => 'LiipImagineBundle', 15 => 'DebugBundle', 16 => 'WebProfilerBundle', 17 => 'SensioDistributionBundle', 18 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/views'), 'MwebAdmin');
        $instance->addPath(($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Mweb/CoreBundle/Resources/views'), 'MwebCore');
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('content_image' => array('uri_prefix' => '/files/uploads/content', 'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/content'), 'inject_on_load' => true, 'namer' => array('service' => NULL, 'options' => NULL), 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'db_driver' => 'orm'), 'parallax_image' => array('uri_prefix' => '/files/uploads/content', 'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/content'), 'inject_on_load' => true, 'namer' => array('service' => NULL, 'options' => NULL), 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'db_driver' => 'orm'), 'news_image' => array('uri_prefix' => '/files/uploads/news', 'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/news'), 'inject_on_load' => true, 'namer' => array('service' => NULL, 'options' => NULL), 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'db_driver' => 'orm'), 'artist_image' => array('uri_prefix' => '/files/uploads/artist', 'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/artist'), 'inject_on_load' => true, 'namer' => array('service' => NULL, 'options' => NULL), 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MwebAdminBundle' => 'Mweb\\AdminBundle\\MwebAdminBundle',
                'MwebCoreBundle' => 'Mweb\\CoreBundle\\MwebCoreBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MwebAdminBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'/vendor/mweb/admin-bundle/Mweb/AdminBundle'),
                    'namespace' => 'Mweb\\AdminBundle',
                ),
                'MwebCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Mweb/CoreBundle'),
                    'namespace' => 'Mweb\\CoreBundle',
                ),
                'LexikTranslationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/lexik/translation-bundle'),
            ...
            'lexik_translation.auto_cache_clean' => true,
            ...
            'assetic.bundles' => array(
                ...
                7 => 'MwebAdminBundle',
                8 => 'MwebCoreBundle',
                9 => 'LexikTranslationBundle',
                10 => 'AsseticBundle',
                11 => 'FOSUserBundle',
                12 => 'StofDoctrineExtensionsBundle',
                13 => 'VichUploaderBundle',
                14 => 'LiipImagineBundle',
                15 => 'DebugBundle',
            ...
            'fos_user.model.user.class' => 'Mweb\\AdminBundle\\Entity\\User',
            ...
            'vich_uploader.mappings' => array(
                ...
                'news_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/news'),
                    'inject_on_load' => true,
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                ...
                'artist_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/artist'),
                    'inject_on_load' => true,
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
...
class DoctrineORMEntityManager_0000000016db6a4e0000564c26747116d92a10d44120ed4a6a0e91acee8b0f15 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58a9f1de7ff67007927408 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58a9f1de7ff7c154325828 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58a9f1de7ff32709394689 = array(
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getConnection', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getConnection();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getMetadataFactory', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getMetadataFactory();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getExpressionBuilder', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getExpressionBuilder();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'beginTransaction', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->beginTransaction();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getCache', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getCache();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'transactional', array('func' => $func), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->transactional($func);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'commit', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->commit();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'rollback', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->rollback();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getClassMetadata', array('className' => $className), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getClassMetadata($className);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'createQuery', array('dql' => $dql), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->createQuery($dql);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'createNamedQuery', array('name' => $name), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->createNamedQuery($name);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'createQueryBuilder', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->createQueryBuilder();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'flush', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->flush($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'clear', array('entityName' => $entityName), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->clear($entityName);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'close', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->close();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'persist', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->persist($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'remove', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->remove($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'refresh', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->refresh($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'detach', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->detach($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'merge', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->merge($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->copy($entity, $deep);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getRepository($entityName);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'contains', array('entity' => $entity), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->contains($entity);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getEventManager', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getEventManager();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getConfiguration', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getConfiguration();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'isOpen', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->isOpen();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getUnitOfWork', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getUnitOfWork();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getProxyFactory', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getProxyFactory();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'initializeObject', array('obj' => $obj), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->initializeObject($obj);
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'getFilters', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->getFilters();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'isFiltersStateClean', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->isFiltersStateClean();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'hasFilters', array(), $this->initializer58a9f1de7ff7c154325828);

        return $this->valueHolder58a9f1de7ff67007927408->hasFilters();
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 = $initializer;
    }
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__get', array('name' => $name), $this->initializer58a9f1de7ff7c154325828);

        if (isset(self::$publicProperties58a9f1de7ff32709394689[$name])) {
            return $this->valueHolder58a9f1de7ff67007927408->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58a9f1de7ff67007927408;
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58a9f1de7ff7c154325828);
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__isset', array('name' => $name), $this->initializer58a9f1de7ff7c154325828);
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__unset', array('name' => $name), $this->initializer58a9f1de7ff7c154325828);
    ...
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__clone', array(), $this->initializer58a9f1de7ff7c154325828);

        $this->valueHolder58a9f1de7ff67007927408 = clone $this->valueHolder58a9f1de7ff67007927408;
    }

    public function __sleep()
    {
        $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, '__sleep', array(), $this->initializer58a9f1de7ff7c154325828);

        return array('valueHolder58a9f1de7ff67007927408');
    }
    ...
    {
        return $this->initializer58a9f1de7ff7c154325828;
    }
    ...
    {
        return $this->initializer58a9f1de7ff7c154325828 && $this->initializer58a9f1de7ff7c154325828->__invoke($this->valueHolder58a9f1de7ff67007927408, $this, 'initializeProxy', array(), $this->initializer58a9f1de7ff7c154325828);
    }
    ...
    {
        return null !== $this->valueHolder58a9f1de7ff67007927408;
    }
    ...
    {
        return $this->valueHolder58a9f1de7ff67007927408;
    }


}

class FOSUserBundleDoctrineUserManager_0000000016db6b3a0000564c26747116d92a10d44120ed4a6a0e91acee8b0f15 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58a9f1de8a253674816726 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58a9f1de8a266697841651 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58a9f1de8a22b163243659 = array(
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'deleteUser', array('user' => $user), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->deleteUser($user);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'getClass', array(), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->getClass();
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUserBy($criteria);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUsers', array(), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUsers();
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'reloadUser', array('user' => $user), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->reloadUser($user);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->updateUser($user, $andFlush);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'createUser', array(), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->createUser();
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUserByEmail', array('email' => $email), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUserByEmail($email);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUserByUsername', array('username' => $username), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUserByUsername($username);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUserByUsernameOrEmail($usernameOrEmail);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->findUserByConfirmationToken($token);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->updateCanonicalFields($user);
    }
    ...
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'updatePassword', array('user' => $user), $this->initializer58a9f1de8a266697841651);

        return $this->valueHolder58a9f1de8a253674816726->updatePassword($user);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer58a9f1de8a266697841651 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__get', array('name' => $name), $this->initializer58a9f1de8a266697841651);

        if (isset(self::$publicProperties58a9f1de8a22b163243659[$name])) {
            return $this->valueHolder58a9f1de8a253674816726->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58a9f1de8a253674816726;
    ...
    public function __set($name, $value)
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58a9f1de8a266697841651);
    ...
    public function __isset($name)
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__isset', array('name' => $name), $this->initializer58a9f1de8a266697841651);
    ...
    public function __unset($name)
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__unset', array('name' => $name), $this->initializer58a9f1de8a266697841651);
    ...
    public function __clone()
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__clone', array(), $this->initializer58a9f1de8a266697841651);

        $this->valueHolder58a9f1de8a253674816726 = clone $this->valueHolder58a9f1de8a253674816726;
    }

    public function __sleep()
    {
        $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, '__sleep', array(), $this->initializer58a9f1de8a266697841651);

        return array('valueHolder58a9f1de8a253674816726');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer58a9f1de8a266697841651;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer58a9f1de8a266697841651 && $this->initializer58a9f1de8a266697841651->__invoke($this->valueHolder58a9f1de8a253674816726, $this, 'initializeProxy', array(), $this->initializer58a9f1de8a266697841651);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder58a9f1de8a253674816726;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58a9f1de8a253674816726;
    }
