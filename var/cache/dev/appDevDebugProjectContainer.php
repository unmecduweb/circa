...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KRq3WbYif4', 0, 'bM4lyRftpt6iku37O7xqxj', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cObhH-Rsq5', 0, 'bM4lyRftpt6iku37O7xqxj', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hzhvmYrFrr', 0, 'bM4lyRftpt6iku37O7xqxj', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000065bdc90d00005561379376414c8c342f60845e0453553f97c8908d86(
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = new FOSUserBundleDoctrineUserManager_0000000065bdcb1e00005561379376414c8c342f60845e0453553f97c8908d86(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c, $d), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $m, 'main', $o, $p, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '589dba8a201f94.67458306', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $l, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $m, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mweb_admin.entities' => array(
                ...
                'paralax' => array(
                    'beautyName' => 'Illustrations',
                    'menu' => 'paralax',
                    'class' => 'Mweb\\CoreBundle\\Entity\\Paralax',
                    'form' => '\\Mweb\\CoreBundle\\Form\\ParalaxType',
                    'views' => 'default',
                    'listProperties' => array(
                        'name' => array(
                            'dataName' => 'title',
            ...
            'vich_uploader.mappings' => array(
                ...
                'parallax_image' => array(
                    'uri_prefix' => '/files/uploads/paralax',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/files/uploads/paralax'),
                    'inject_on_load' => true,
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
...
class DoctrineORMEntityManager_0000000065bdc90d00005561379376414c8c342f60845e0453553f97c8908d86 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder589dba8ac343b439717588 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer589dba8ac3451472042444 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties589dba8ac3405603827850 = array(
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getConnection', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getConnection();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getMetadataFactory', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getMetadataFactory();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getExpressionBuilder', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getExpressionBuilder();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'beginTransaction', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->beginTransaction();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getCache', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getCache();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'transactional', array('func' => $func), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->transactional($func);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'commit', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->commit();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'rollback', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->rollback();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getClassMetadata', array('className' => $className), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getClassMetadata($className);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'createQuery', array('dql' => $dql), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->createQuery($dql);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'createNamedQuery', array('name' => $name), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->createNamedQuery($name);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'createQueryBuilder', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->createQueryBuilder();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'flush', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->flush($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'clear', array('entityName' => $entityName), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->clear($entityName);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'close', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->close();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'persist', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->persist($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'remove', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->remove($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'refresh', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->refresh($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'detach', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->detach($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'merge', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->merge($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->copy($entity, $deep);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getRepository', array('entityName' => $entityName), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getRepository($entityName);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'contains', array('entity' => $entity), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->contains($entity);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getEventManager', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getEventManager();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getConfiguration', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getConfiguration();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'isOpen', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->isOpen();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getUnitOfWork', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getUnitOfWork();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getProxyFactory', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getProxyFactory();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'initializeObject', array('obj' => $obj), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->initializeObject($obj);
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'getFilters', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->getFilters();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'isFiltersStateClean', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->isFiltersStateClean();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'hasFilters', array(), $this->initializer589dba8ac3451472042444);

        return $this->valueHolder589dba8ac343b439717588->hasFilters();
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 = $initializer;
    }
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__get', array('name' => $name), $this->initializer589dba8ac3451472042444);

        if (isset(self::$publicProperties589dba8ac3405603827850[$name])) {
            return $this->valueHolder589dba8ac343b439717588->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder589dba8ac343b439717588;
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer589dba8ac3451472042444);
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__isset', array('name' => $name), $this->initializer589dba8ac3451472042444);
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__unset', array('name' => $name), $this->initializer589dba8ac3451472042444);
    ...
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__clone', array(), $this->initializer589dba8ac3451472042444);

        $this->valueHolder589dba8ac343b439717588 = clone $this->valueHolder589dba8ac343b439717588;
    }

    public function __sleep()
    {
        $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, '__sleep', array(), $this->initializer589dba8ac3451472042444);

        return array('valueHolder589dba8ac343b439717588');
    }
    ...
    {
        return $this->initializer589dba8ac3451472042444;
    }
    ...
    {
        return $this->initializer589dba8ac3451472042444 && $this->initializer589dba8ac3451472042444->__invoke($this->valueHolder589dba8ac343b439717588, $this, 'initializeProxy', array(), $this->initializer589dba8ac3451472042444);
    }
    ...
    {
        return null !== $this->valueHolder589dba8ac343b439717588;
    }
    ...
    {
        return $this->valueHolder589dba8ac343b439717588;
    }


}

class FOSUserBundleDoctrineUserManager_0000000065bdcb1e00005561379376414c8c342f60845e0453553f97c8908d86 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder589dba8acefd4554707600 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer589dba8acefe3086037098 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties589dba8acefae496952263 = array(
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'deleteUser', array('user' => $user), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->deleteUser($user);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'getClass', array(), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->getClass();
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUserBy($criteria);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUsers', array(), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUsers();
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'reloadUser', array('user' => $user), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->reloadUser($user);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->updateUser($user, $andFlush);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'createUser', array(), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->createUser();
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUserByEmail', array('email' => $email), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUserByEmail($email);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUserByUsername', array('username' => $username), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUserByUsername($username);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUserByUsernameOrEmail($usernameOrEmail);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->findUserByConfirmationToken($token);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->updateCanonicalFields($user);
    }
    ...
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'updatePassword', array('user' => $user), $this->initializer589dba8acefe3086037098);

        return $this->valueHolder589dba8acefd4554707600->updatePassword($user);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer589dba8acefe3086037098 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__get', array('name' => $name), $this->initializer589dba8acefe3086037098);

        if (isset(self::$publicProperties589dba8acefae496952263[$name])) {
            return $this->valueHolder589dba8acefd4554707600->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder589dba8acefd4554707600;
    ...
    public function __set($name, $value)
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer589dba8acefe3086037098);
    ...
    public function __isset($name)
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__isset', array('name' => $name), $this->initializer589dba8acefe3086037098);
    ...
    public function __unset($name)
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__unset', array('name' => $name), $this->initializer589dba8acefe3086037098);
    ...
    public function __clone()
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__clone', array(), $this->initializer589dba8acefe3086037098);

        $this->valueHolder589dba8acefd4554707600 = clone $this->valueHolder589dba8acefd4554707600;
    }

    public function __sleep()
    {
        $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, '__sleep', array(), $this->initializer589dba8acefe3086037098);

        return array('valueHolder589dba8acefd4554707600');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer589dba8acefe3086037098;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer589dba8acefe3086037098 && $this->initializer589dba8acefe3086037098->__invoke($this->valueHolder589dba8acefd4554707600, $this, 'initializeProxy', array(), $this->initializer589dba8acefe3086037098);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder589dba8acefd4554707600;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder589dba8acefd4554707600;
    }
